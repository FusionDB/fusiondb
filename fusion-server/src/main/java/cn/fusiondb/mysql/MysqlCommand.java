...
public enum MysqlCommand {
    ...
    COM_BINLOG_DUMP("Binlog dump", 18),
    COM_TABLE_DUMP("Table dump", 19),
    COM_CONNECT_OUT("Connect out", 20),
    COM_REGISTER_SLAVE("Register slave", 21),
    ...
    COM_BINLOG_DUMP_GTID("COM_BINLOG_DUMP_GTID", 30),
